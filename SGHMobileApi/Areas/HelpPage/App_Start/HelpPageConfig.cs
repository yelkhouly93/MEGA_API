...
namespace SGHMobileApi.Areas.HelpPage
{
    /// <summary>
    ...
    public static class HelpPageConfig
    {
        [SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters",
            MessageId = "SGHMobileApi.Areas.HelpPage.TextSample.#ctor(System.String)",
        ...
        {
            XmlDocument apiDoc = new XmlDataDocument();
            apiDoc.Load(HttpContext.Current.Server.MapPath("~/App_Data/XmlDocument.xml"));

            XmlDocument contractsDoc = new XmlDataDocument();
            contractsDoc.Load(HttpContext.Current.Server.MapPath("~/bin/DataLayer.xml"));
