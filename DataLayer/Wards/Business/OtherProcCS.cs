    ...
    public class OtherProcCS
    {
        ...
        public List<Patient> ViewMain()
        {
            try
            {
                ...
                DataSet ds = dl.ExecuteSQLDS("WARDS.WARDS_OTHER_PROC_VIEW", sqlParam);
        ...
        public List<ItemCode> ViewSelected()
        {
            try
            {
                ...
                DataSet ds = dl.ExecuteSQLDS("WARDS.WARDS_OTHER_PROC_SELECTED", sqlParam);
                DataTable dt = ds.Tables[0];
                int i = 1;
                List<ItemCode> li = (
                    from DataRow s in dt.Rows
        ...
        public string SaveOrder(List<ItemCode> model, List<ItemCode> can, string OperatorId)
        {
            try
            {
                ...
                dl.ExecuteSQLDS("WARDS.WARDS_OTHER_PROC_SAVE", sqlParam);                    
        ...
        public string CancelOrder(string OperatorId)
        {
            try
            {
                ...
                dl.ExecuteSQLDS("WARDS.WARDS_OTHER_PROC_CANCEL", sqlParam);
